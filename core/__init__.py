"""/s: Core library for Obsidian-Paper-Tools.
- crossref_api: Crossref REST API & PubMed Entrez E-utilities wrappers with JSON caching.
- doi: DOI regex matching, unicode repair, safe-filename canonicalization.
