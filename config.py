...
DOI_TITLE_CACHE = Path(r'D:\ResearchFront\DATA\API\Doi_Title_cache.json')  # 【勿改】强制硬编码路径
CITE_BY_CACHE = Path(r'D:\ResearchFront\DATA\API\Cite_By_cache.json')  # 【勿改】强制硬编码路径
